MoodMe Emotions Unity Plugin V1.0 (c) MoodMe 2024
...
The plugin is released AS IS with support for plugin errors only, but if you have any question, or want further demo contents, please write to support@mood-me.com and we will try to help you.
